...
```bash
https://github.com/Dao-AILab/causal-conv1d/releases?page=3 下載causal_conv1d-1.1.3.post1+cu118torch2.2cxx11abiFALSE-cp39-cp39-linux_x86_64.whl

python -m pip install   causal_conv1d-1.1.3.post1+cu118torch2.2cxx11abiFALSE-cp39-cp39-linux_x86_64.whl

https://github.com/state-spaces/mamba/releases?page=3 下載mamba_ssm-1.1.4+cu118torch2.2cxx11abiFALSE-cp39-cp39-linux_x86_64.whl

python -m pip install   mamba_ssm-1.1.4+cu118torch2.2cxx11abiFALSE-cp39-cp39-linux_x86_64.whl

https://github.com/Dao-AILab/flash-attention/releases?page=6 下載flash_attn-2.5.6+cu118torch2.2cxx11abiFALSE-cp39-cp39-linux_x86_64.whl
